...
$query = sprintf('SELECT user_id,email,phone FROM %stbl_users WHERE (country_dial_code = "%s" AND (phone= "%s" OR phone="%s")) OR email = "%s"', 
DB_TBL_PREFIX, 
...
$verify_reg  = 0;
$query = sprintf('INSERT INTO %stbl_users (route_id,firstname, lastname, email, phone, pwd_raw, password_hash, account_create_date,referal_code,is_activated,photo_file,country_code,country_dial_code,country) VALUES'.
