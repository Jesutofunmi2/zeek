...
$ride_icon_type = (int) $_POST['car-icon-type'];
$ride_num_seats = (int) $_POST['num-seats'];
if($ride_icon_type < 1){
    $ride_icon_type = 1;
}elseif($ride_icon_type > 6){
    $ride_icon_type = 6;
}
...
//Update ride data
$query = sprintf('UPDATE %stbl_rides SET num_seats = "%d",icon_type = "%d",ride_type = "%s" ,ride_desc = "%s",ride_img = "%s", avail = "%d" WHERE id = "%d"', 
                    DB_TBL_PREFIX,
                    $ride_num_seats,
                    $ride_icon_type, 
