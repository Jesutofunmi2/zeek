...
$query = sprintf('SELECT user_id,email,phone FROM %stbl_users WHERE user_id != %d AND ((country_dial_code = "%s" AND (phone= "%s" OR phone="%s")) OR email = "%s")', 
DB_TBL_PREFIX, 
$id,
...
$verify_reg  = 0;
$query = sprintf('UPDATE %stbl_users SET route_id = "%d",firstname = "%s", lastname = "%s", email = "%s", phone = "%s", pwd_raw = "%s", password_hash = "%s", referal_code = "%s",photo_file = "%s",country_code = "%s",country_dial_code = "%s",country = "%s" WHERE user_id = "%d"', 
    DB_TBL_PREFIX, 
    $route_id,
