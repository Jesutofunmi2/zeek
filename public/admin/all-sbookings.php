...
$GLOBALS['admin_template']['page_title'] = "<i class='fa fa-bookmark'></i> All Scheduled Bookings"; //Set the title of the page on the admin interface
$GLOBALS['admin_template']['active_menu'] = "bookings"; //Set the appropriate menu item active
$GLOBALS['admin_template']['active_sub_menu'] = "sbooking-all"; //Set the appropriate menu item active


$query_modifier = "> 0 AND ". DB_TBL_PREFIX . "tbl_bookings.scheduled = 1";
...
$_SESSION['sbookings-export_query']['q_mod'] = $query_modifier;
$_SESSION['sbookings-export_query']['sort'] = DB_TBL_PREFIX . "tbl_bookings.date_created";
...
$query = sprintf('SELECT *, %1$stbl_bookings.route_id AS booking_route_id, %1$stbl_bookings.id AS booking_id,%1$stbl_bookings.ride_id AS booking_ride,%1$stbl_drivers.firstname AS drvr_firstname, %1$stbl_drivers.lastname AS drvr_lastname  FROM %1$stbl_bookings 
LEFT JOIN %1$stbl_routes ON %1$stbl_routes.id = %1$stbl_bookings.route_id
LEFT JOIN %1$stbl_drivers ON %1$stbl_drivers.driver_id = %1$stbl_bookings.driver_id
LEFT JOIN %1$stbl_rides ON %1$stbl_rides.id = %1$stbl_bookings.ride_id
...
ob_start();
include "../../drop-files/templates/admin/allsbookingstpl.php";
