...
$query = sprintf('INSERT INTO %stbl_routes(pickup_city_id,city_bound_coords,r_title,c_name,pick_name,drop_name,r_scope,lng,lat,pick_lng,pick_lat,drop_lng,drop_lat,dist_unit,city_radius,city_currency_id) VALUES'.
