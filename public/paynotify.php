...
if(isset($_GET['callback']) && $_GET['callback'] == "true"){
    ...
    switch(DEFAULT_PAYMENT_GATEWAY){
        ...
        case "paytm":
        require "../drop-files/lib/pgateways/paytm/paytm-callback.php";
        break;

        case "phonepe":
        require "../drop-files/lib/pgateways/phonepe/phonepe-callback.php";
        break;
        ...
        case "paypal":
        require "../drop-files/lib/pgateways/paypal/paypal-callback.php";
        break;
...
switch(DEFAULT_PAYMENT_GATEWAY){
    ...
    case "paytm":
    require "../drop-files/lib/pgateways/paytm/paytm-gateway.php";
    break;

    case "phonepe":
    require "../drop-files/lib/pgateways/phonepe/phonepe-gateway.php";
    break;
    ...
    case "paypal":
    require "../drop-files/lib/pgateways/paypal/paypal-gateway.php";
    break;
