<div class="row">
    <div class="col-sm-12">
        ...
        Quickly create new staff account. 
        </div>
    </div>
</div> <!--/Row-->
                    ...
                    <div class="form-group">
                        <div  style="margin-left:auto; margin-right:auto; float:none;overflow-x: auto;" class="col-sm-6 col-md-6">
                            <div id="image-editor" style="border:0px">
                                ...
                                <h5 style="text-align:center;"><span style="color:red">*</span>Upload staff passport photo. Adjust position of photo by draging in the box. Use controls below to zoom and rotate.</h5>
                      ...
                      <form  id="reg-form" enctype="multipart/form-data" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['SCRIPT_NAME']); ?>" method="post" >
                             ...
                             <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <label class="radio-inline">
                                        <input checked type="radio" name="accounttype" id="biller" value="5"> Biller
                                    </label>
                                    <label class="radio-inline">
                                        <input checked type="radio" name="accounttype" id="dispatcher" value="2"> Dispatcher
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="accounttype" id="admin" value="3"> Admin
                                    </label>                            
                                </div>
                            </div> 
                               ...
                               <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control" id="route-city" name="route-city">
                                        ...
                                        ?> 
                                            <option value="<?php echo $routedata['r_id']; ?>"><?php echo $routedata['r_title']; ?></option>
                                        <?php
                                            }
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <label for="refcode" style='display:block'>Account Activation</label>
                                    <input id="activateacc" checked type="checkbox" name="activateacc"> Activate
                                </div>
                              ...
                              <hr />
                           <button id="create" type="submit" class="btn btn-primary btn-block" value="1" name="create" >Create Staff</button> 
                        </form>
