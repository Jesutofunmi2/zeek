<?php
$driver_bookings_data = [];
$query_modifier  = " = {$id}";
$number_of_bookings = 0;


//get number of transactions
$query = sprintf('SELECT COUNT(*) FROM %1$stbl_bookings WHERE %1$stbl_bookings.driver_id %2$s', DB_TBL_PREFIX, $query_modifier);
...
//calculate pages
if(isset($_GET['page']) && (isset($_GET['tab']) && $_GET['tab'] == "dbookings")){
        ...
        <div class="box-body">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    foreach($driver_bookings_data as $bookingspageitems){
                        ...
                        $customer_details = $bookingspageitems['user_firstname'] . " " . $bookingspageitems['user_lastname'] . "<br>" . $bookingspageitems['country_dial_code']. " " . (!empty(DEMO) ? mask_string($bookingspageitems['user_phone']) : $bookingspageitems['user_phone']);
                        ...
                        echo "<tr><td>".$count++."</td><td>". str_pad($bookingspageitems['booking_id'] , 5, '0', STR_PAD_LEFT) . "</td><td>".$customer_details."</td><td>". $bookingspageitems['pickup_address'] ."</td><td>". $bookingspageitems['dropoff_address'] ."</td><td>".date('l, M j, Y H:i:s',strtotime($bookingspageitems['date_created'].' UTC')) ."</td><td title='{$estimated_cost_local}' >".$estimated_cost."</td><td title='{$amount_paid_local}' >".$amount_paid."</td><td>". $paymethod ."</td><td>".$booking_status."</td><td>". $view_details . $track_ride ."</td></tr>";
            ...
            <?php if(empty($driver_bookings_data)){ echo "<h1 style='text-align:center;'>Nothing to Show. No Booking Data.</h1>";} ?>
