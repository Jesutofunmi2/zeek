...
<div class="row">
    <div class="col-sm-12">
        ...
        Respond to support messages from your drivers. 
        </div>
    </div>
</div>
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    foreach($open_chat_support_data as $userdata){
                        ...
                        $view_user = "<a href='view-driver.php?id={$userdata['driver_id']}' class='btn btn-xs btn-primary'>View</a>";

                        $chat_btn = "<a href='#' class='btn btn-xs btn-success chat-btn' data-userid='{$userdata['driver_id']}' >Open chat</a>";
                        $close_chat_btn = "<a href='#' class='btn btn-xs btn-warning close-chat-btn' data-userid='{$userdata['driver_id']}' >Close chat</a>";
...
function chat_support_msg_send(){
    ...
    var post_data = {'action':'senddriverchatsupportmsg','userid' : send_user_id, 'msg' : msg};
...
$('.close-chat-btn').on('click', function(e){
    ...
    var post_data = {'action':'closedriverchatsupport','userid' : user_id};
    $.ajax({
        url: ajaxurl,
        type: 'POST',
        timeout : 60000,
...
$('.chat-btn').on('click', function(e){
  ...
  var post_data = {'action':'getdriverchatsupportmsg','userid' : user_id};
  $.ajax({
      url: ajaxurl,
      type: 'POST',
      timeout : 60000,
...
function updatechatcontent(userid){
    ...
    upd_chat_content_timer_handle = setInterval(function(){
        ...
        var post_data = {'action':'getdriverchatsupportmsg','userid' : userid};
