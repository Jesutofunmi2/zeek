            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            ...
                            <a href="edit-staff.php?id=<?php echo  $user_page_items['user_ids']; ?>" class="btn btn-primary btn-sm">Edit Profile</a>
                            <br>
                        </div>
                        <div class="col-sm-5" style="border-left:thin solid #ccc;">  
                            <?php
                                $account_type = 'N/A';
                                switch($user_page_items['account_type']){
                                    case 1:
                                    $account_type = 'Rider';
                                    break;
                                    case 2:
        ...
        <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane <?php echo $active_tab == 0 ? 'active' : ''?>" id="tab_1">
                        <?php include('../../drop-files/templates/admin/viewstafftransactionstpl.php'); ?>
                    </div>
                    <!-- /.tab-pane -->
                    <div class="tab-pane <?php echo $active_tab == 1 ? 'active' : ''?>" id="tab_2">
                        <?php include('../../drop-files/templates/admin/viewstaffbookingstpl.php'); ?>
                    </div>
                   <!-- /.tab-pane -->
                    <div class="tab-pane <?php echo $active_tab == 2 ? 'active' : ''?>" id="tab_3">
                        <?php include('../../drop-files/templates/admin/viewstaffreviewstpl.php'); ?>
                    </div>
                    <!-- /.tab-pane -->
                    <div class="tab-pane <?php echo $active_tab == 3 ? 'active' : ''?>" id="tab_4">
                        <?php include('../../drop-files/templates/admin/viewstaffdocumentstpl.php'); ?>
                    </div>
                    <!-- /.tab-pane -->
...
$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
  ...
  if(tab_href && tab_href == active_tab){
    ...
    switch(tab_href){
        case '#tab_1':
        history.replaceState({},'',default_url + '&tab=stransactions');    
        break;
        case '#tab_2':
        history.replaceState({},'',default_url + '&tab=sbookings');    
        break;        
        case '#tab_3':
        history.replaceState({},'',default_url + '&tab=sreviews');    
        break;
        case '#tab_4':
        history.replaceState({},'',default_url + '&tab=sdocuments');    
        break;
    };
  }
})
