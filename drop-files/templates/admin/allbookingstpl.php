            ...
            <div class="row">
              <div class="col-sm-12">
                  <div class="alert alert-info alert-dismissible">
                    ...
                    View all Instant ride bookings.
                  </div>
              </div>
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text">All Instant Bookings</span>
              ...
              <div class="col-sm-12">   
                <div class="box box-success">
                  <div class="box-header with-border">
                    ...
                    <h3 class="box-title">All Instant Bookings <?php if($number_of_bookings) echo "- Showing " . $page_number ." of ". $pages; ?></h3>
                          ...
                          $default_currency_symbol = !empty($_SESSION['default_currency']) ? $_SESSION['default_currency']['symbol'] : "₦";
                              foreach($bookings_page_items as $bookingspageitems){
                                  ...
                                  if($bookingspageitems['status'] == 1 || $bookingspageitems['status'] == 3){  
                                    ...
                                    $del_action = " <a data-msg='Are you sure you want to delete this booking?' href='edit-booking.php?rdir=all-bookings.php&action=delete&id=".$bookingspageitems['booking_id'] ."' class='btn-margin-top delete-item btn btn-danger btn-xs'>Delete</a>";
                                  }
                                  ...
                                  if($bookingspageitems['status'] == 1 && !empty($bookingspageitems['location_date'])){ 
                                    ...
                                    $track_ride = " <a data-routeid='{$bookingspageitems['route_id']}' data-driverid = '{$bookingspageitems['driver_id']}' data-datetime='{$location_date}' data-lat='{$bookingspageitems['lat']}' data-long='{$bookingspageitems['long']}' href='#driver-location-map-container' class='btn-margin-top btn btn-xs btn-success drvr-location' >Track</a>";
                                  }else{
                                    $track_ride = '';
                                  }
                                  
                                  if($bookingspageitems['status'] == 0 && empty($bookingspageitems['driver_id'])){  
                                    $edit_action = " <a href='edit-booking.php?action=edit&id=".$bookingspageitems['booking_id'] ."' class='btn-margin-top btn btn-success btn-xs'>Modify</a>";
                                  }else{
                                    $edit_action = '';
                                  }

                                  if($bookingspageitems['status'] == 3){  
                                    $invoice_action = '';//" <a href='booking-invoice.php?bkid=".$bookingspageitems['booking_id'] ."' class='btn btn-success btn-xs'>Invoice</a>";
                                  }else{
                                    $invoice_action = '';
                                  }

                                  $view_details = "<a href='view-booking.php?bkid=".$bookingspageitems['booking_id'] ."' class='btn-margin-top btn btn-primary btn-xs'>View</a> ";
...
$('#export_data_btn').on('click', function(e){
  ...
  var post_data = {'action':'exportBookings','type': export_file_format};
  $.ajax({
      url: ajaxurl,
      type: 'POST',
      timeout : 60000,
