...
$query_modifier  = ' = 0 AND ' . DB_TBL_PREFIX . 'tbl_wallet_transactions.user_id = ' . $id;
...
//calculate pages
if(isset($_GET['page']) && (isset($_GET['tab']) && $_GET['tab'] == "stransactions")){
        ...
        <div class="box-body">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    foreach($user_transaction_data as $usertransactiondata){
                        $transaction_type = '';
                        $booking_id = !empty($usertransactiondata['book_id']) ? "<a href='view-booking.php?bkid={$usertransactiondata['book_id']}'>" . str_pad($usertransactiondata['book_id'] , 5, '0', STR_PAD_LEFT) . "</a>" : 'N/A';
                        switch($usertransactiondata['type']){
                            case 0:
                        ...
                        echo "<tr><td>". $count++ . "</td><td>" . strtoupper($usertransactiondata['transaction_id']) . "</td><td>" . $usertransactiondata['cur_symbol']. $usertransactiondata['amount']. "</td><td>" . $default_currency_symbol . $usertransactiondata['wallet_balance'] ."</td><td>". $booking_id ."</td><td>". $transaction_type . "</td><td>" .$usertransactiondata['desc'] . "</td><td>" . date('l, M j, Y H:i:s',strtotime($usertransactiondata['transaction_date'].' UTC')) . "</td><td></tr>";
                    }
            ...
            <?php if(empty($user_transaction_data)){ echo "<h1 style='text-align:center;'>Nothing to Show. No Transaction Data.</h1>";} ?>
