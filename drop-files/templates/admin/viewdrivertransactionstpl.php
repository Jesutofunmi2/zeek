<?php
$driver_transaction_data = [];
$query_modifier  = ' = 1 AND ' . DB_TBL_PREFIX . 'tbl_wallet_transactions.user_id = ' . $id;
...
//calculate pages
if(isset($_GET['page']) && (isset($_GET['tab']) && $_GET['tab'] == "dtransactions")){
        ...
        <div class="box-body">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    foreach($driver_transaction_data as $drivertransactiondata){
                        $transaction_type = '';
                        $booking_id = !empty($drivertransactiondata['book_id']) ? "<a href='view-booking.php?bkid={$drivertransactiondata['book_id']}'>" . str_pad($drivertransactiondata['book_id'] , 5, '0', STR_PAD_LEFT) . "</a>" : 'N/A';
                        switch($drivertransactiondata['type']){
                            case 0:
                        ...
                        echo "<tr><td>". $count++ . "</td><td>" . strtoupper($drivertransactiondata['transaction_id']) . "</td><td>" . $drivertransactiondata['cur_symbol']. $drivertransactiondata['amount']. "</td><td>" . $default_currency_symbol . $drivertransactiondata['wallet_balance'] ."</td><td>". $booking_id ."</td><td>". $transaction_type . "</td><td>" .$drivertransactiondata['desc'] . "</td><td>" . date('l, M j, Y H:i:s',strtotime($drivertransactiondata['transaction_date'].' UTC')) . "</td><td></tr>";
                    }
            ...
            <?php if(empty($driver_transaction_data)){ echo "<h1 style='text-align:center;'>Nothing to Show. No Transaction Data.</h1>";} ?>
