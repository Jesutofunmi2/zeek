<div class="row">
    <div class="col-sm-12">
        ...
        Quickly create new customer account. 
        </div>
    </div>
</div> <!--/Row-->
    ...
    <div class="col-sm-10" >
		<div class="box box-success">
            ...
            <div class="box-body">
                      ...
                      <form  enctype="multipart/form-data" id="reg-form" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['SCRIPT_NAME']); ?>" method="post" >
                            ...
                            <div class="form-group">
                              ...
                              <hr />
                           <button type="submit" class="btn btn-primary btn-block" value="1" id="create" name="create" >Create Customer</button> 
                        </form>
