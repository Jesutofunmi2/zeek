<div class="row">
    <div class="col-sm-12">
        ...
        Create and manage documents required by drivers for registration on the service. 
        </div>
    </div>
</div> <!--/Row-->
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($documents_data as $documentsdata){
                                    ...
                                    $doc_status = empty($documentsdata['status']) ? "<a href='ddocuments.php?status=1&did={$documentsdata['did']}' class='btn btn-xs btn-success'>Activate</a> " : "<a href='ddocuments.php?status=0&did={$documentsdata['did']}' class='btn btn-xs btn-danger'>Deactivate</a>";
