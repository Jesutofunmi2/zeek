...
//file_put_contents('paytm_dump',print_r($_POST, true));

$gateway_data = $_POST;


if(!(isset($gateway_data['STATUS']) && $gateway_data['STATUS'] == 'TXN_SUCCESS')){
    exit;
}

$gateway_transaction_id = $gateway_data['TXNID'];

$transaction_ref = $gateway_data['ORDERID'];
$transaction_data = [];
...
$response_message = $gateway_data['RESPMSG'];
